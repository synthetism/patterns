...
describe('RealtimeService Pattern', () => {
  ...
  it('should handle multiple subscribers for the same event', () => {
    ...
    // Simulate an event
    realtimeService.simulateEvent('post', 'update', { id: 2, title: 'Updated Post' });
  ...
  it('should handle observer objects properly', () => {
    ...
    // Simulate an event
    realtimeService.simulateEvent('comment', 'create', { id: 4, text: 'Nice post!' });
  ...
  it('should allow unsubscribing event handlers', () => {
    ...
    realtimeService.simulateEvent('notification', 'create', { id: 5, message: 'New message' });
    expect(handler.update).toHaveBeenCalledTimes(1);
    ...
    realtimeService.simulateEvent('notification', 'create', { id: 6, message: 'Another message' });
  ...
  it('should maintain independent event streams for different entities', () => {
    ...
    // Simulate user event
    realtimeService.simulateEvent('user', 'update', { id: 7, name: 'Updated User' });
    
    expect(userHandler.update).toHaveBeenCalledTimes(1);
    expect(postHandler.update).not.toHaveBeenCalled();
    
    // Simulate post event
    realtimeService.simulateEvent('post', 'update', { id: 8, title: 'Updated Title' });
